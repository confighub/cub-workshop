...
export function publishBundle({ reference, files, receipt, title }) {
  ...
  const pushed = oras(["push", target, "--artifact-type", BUNDLE_TYPE, "--annotation", `org.opencontainers.image.title=${title}`, "--annotation", "org.opencontainers.image.created=1970-01-01T00:00:00Z", `bundle.tar.gz:${LAYER_TYPE}`], { plain, cwd: work });
